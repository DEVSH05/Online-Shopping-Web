...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to Devush!</h1>
                    <p>We have the best gaming gadgests with great offers. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/RTX4090.jpg" alt="GPU">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RTX4090</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Steamdeck.jpg" alt="Handheld">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Steamdeck</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Xboxcontroller.jpg" alt="Contoller">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>XBOX Elite</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/MechlKeyboard.jpg" alt="Keyboard">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/PS5Controller.jpg" alt="Controller">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>PS5Controller</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cloud3head.jpg" alt="Headphones">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>cloud3head</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/legion9i.jpg" alt="Legion9i">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Legion9i</h3>
                                    <p>Price: Rs. 450000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/g502.jpg" alt="Mouse">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>G502</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rogally.jpg" alt="Handheld">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Rog Ally</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/switch.jpg" alt="Handheld">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Swtich</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/buds2.jpg" alt="earbuds">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Buds2 Pro</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/PS5.jpg" alt="Console">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>PS5</h3>
